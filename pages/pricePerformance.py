                    ...
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.H6(
                                        ["Cash Flows from Funding"], className="subtitle padded"
                                    ),
                        ...
                        [
                            html.Div(
                                [
                                    html.H6(
                                        [
                                            "Average annual returns--updated monthly as of 02/01/2022"
                                        ],
                                        className="subtitle padded",
                                    ),
                                    html.Div(
                        ...
                        [
                            html.Div(
                                [
                                    html.H6(
                                        [
                                            "After-tax returns--updated quarterly as of 12/20/2022"
                                        ],
                                        className="subtitle padded",
                                    ),
                                    html.Div(
